...
plt.tight_layout()
plt.savefig("/workspaces/email-classifier-xgboost/training_models/optimization_curves.png")
plt.show()
...
joblib.dump(final_pipeline, "/workspaces/email-classifier-xgboost/models/xgboost_model.pkl")